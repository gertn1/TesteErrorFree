...
export const InputRootContent = styled.div`
  position: relative;
`;

export const InputRootInputContent = styled.div<Props>`
  align-items: center;
...
export const InputContentError = styled(InputRootInputContent)<Props>`
  border: 1px solid ${({ theme }) => theme.colors.error};
`;

export const InputRootIcon = styled.label<Props>`
  align-items: center;
